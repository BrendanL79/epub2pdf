...
/**
 * Just a marker interface. If DTBook content handling is implemented
 * there will be a sibling class to "Xhtml" that also implements ContentFile,
 * and perhaps some overlapping content will be determined at that time.
 * @author brendanl
 *
 */
